               ...
               <div class="mobile-sidebar-header d-md-none">
                ...
                <div class="sidebar-menu-content">
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        <li class="nav-item">
                            <?php if ($_SESSION['um']=="bd")  {  ?> <a href="branchadmin.php" class="nav-link"> <?php    }    else    {     ?>    <a href="admindashboard.php" class="nav-link">  <?php  }   ?>
                        ...
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu">
                                <li class="nav-item">
                                    <a href="enquirylist.php" class="nav-link"><i
                                            class="fas fa-angle-right"></i>Enquiry List</a>
                                </li>
                                <li class="nav-item">
                                    <a href="admissionlist.php" class="nav-link"><i
                                            class="fas fa-angle-right"></i>Admission List</a>
                                </li>

                                <li class="nav-item">
                                    <a href="allstudentlist.php" class="nav-link"><i class="fas fa-angle-right"></i>All
                                        Students</a>
                                </li>
                                <li class="nav-item">
                        ...
                        <li class="nav-item sidebar-nav-item">
                            <a href="#" class="nav-link"><i
                                    class="flaticon-multiple-users-silhouette"></i><span>Branch</span></a>
                            <ul class="nav sub-group-menu">

                                <li class="nav-item">
                                    <a href="teacher-details.html" class="nav-link"><i
                                            class="fas fa-angle-right"></i>Branch Details</a>
                                </li>
                        ...
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu">
                              <li class="nav-item">
                                  <a href="billslist.php" class="nav-link"><i
                                          class="fas fa-angle-right"></i>Bill List</a>
                              </li>
                                <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="user-account.php" class="nav-link"><i
